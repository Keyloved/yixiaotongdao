...
public interface UserService {
    ...
    int updateUserInfoOpen (HashMap<String, Object> paramMap) throws Exception;

    User checkUser (String openId) throws Exception;

    User getUserInfoByOpenId(HashMap<String,Object> paramMap) throws Exception;
}
